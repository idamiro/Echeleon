...
### Wordmark
- `wordmark/vulcet-wordmark.svg` — black (reference geometry)
- `wordmark/vulcet-wordmark-white.svg` — white
- `wordmark/vulcet-wordmark.png` — master raster
- `wordmark/vulcet-wordmark-site.png` — site header height (188px)
- `wordmark/vulcet-wordmark-white.png` / `-white-site.png`

### Mark (three bars)
- `mark/vulcet-mark.svg` / `.png` — transparent
- `mark/vulcet-mark-white.svg` / `.png`
- `mark/vulcet-mark-badge.svg` / `.png` — on dark rounded square
...
1. Always keep the three-bar E — do not draw a standard E in the wordmark.
