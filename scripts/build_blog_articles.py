...
scope_faq = [
    ...
    (
        "What is a content-led growth platform?",
...
scope_body = '''
        ...
        <div class="article-faq">
          ...
          <div><h3>What is a content-led growth platform?</h3><p>A deeper site built to evolve: stronger architecture, multilingual or CMS structure, and room for case studies, news or ongoing pages.</p></div>
